...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net clk_wiz_0_clk_100m [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_100m] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins mig_7series_0/sys_clk_i] [get_bd_pins rst_clk_wiz_0_100M/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_clk_200m [get_bd_pins clk_wiz_0/clk_200m] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins mig_7series_0/clk_ref_i] [get_bd_pins rst_clk_wiz_0_200M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_clk_wiz_0_200M_peripheral_aresetn [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins rst_clk_wiz_0_200M/peripheral_aresetn]
  ...
  connect_bd_net -net rst_n_1 [get_bd_ports rst_n] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins rst_clk_wiz_0_100M/ext_reset_in] [get_bd_pins rst_clk_wiz_0_200M/ext_reset_in]
